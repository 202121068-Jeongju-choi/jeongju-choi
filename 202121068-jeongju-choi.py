...
def main():
    st.write('202121068 최정주 일반적으로 폐루프 전달함수는 별도의 피드백함수 H(s)와 G(s)가 함께 있어야 구할 수 있지만, 피드백함수가 명확하지 않으면 몇 가지 방법으로 추정할 수 있습니다. 이곳에서는 피드백함수 H(s) = 1 로 가정하여 그래프를 작성해보았습니다.')
